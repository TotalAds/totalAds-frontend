      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-6 shadow-2xl hover:bg-white/15 transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-300 text-sm font-medium">API Tokens</p>
                <p className="text-3xl font-bold text-white">
                  {stats.totalTokens}
                </p>
              </div>
          ...
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <h3 className="font-semibold text-white">Create API Token</h3>
                  <p className="text-sm text-gray-300">
              ...
              >
                ...
                <div>
                  <h3 className="font-semibold text-white">Billing & Usage</h3>
                  <p className="text-sm text-gray-300">
          ...
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="space-y-6">
              ...
              {stats.currentPlan === "pro" && (
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">This Month&apos;s Bill</span>
                  <span className="font-semibold text-white">
                    ${loading ? "..." : stats.billingAmount.toFixed(2)}
                  </span>
                </div>
